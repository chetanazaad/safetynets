document.addEventListener("DOMContentLoaded", () => {
        ...
        div.innerHTML = `
            <svg id="liquid-gradients-svg" style="position: absolute; width: 0; height: 0; overflow: hidden;" width="0" height="0">
                <defs>
                    ...
                    <radialGradient id="liq-grad-gold-1" cx="50%" cy="50%" r="50%">
                        <stop offset="0%" stop-color="#b38600" />
                        <stop offset="40%" stop-color="#e6b800" />
                        <stop offset="75%" stop-color="#ffd54f" />
                        <stop offset="100%" stop-color="#665000" />
                    </radialGradient>
                    <radialGradient id="liq-grad-gold-2" cx="40%" cy="40%" r="55%">
                        <stop offset="0%" stop-color="#665000" />
                        <stop offset="40%" stop-color="#b38600" />
                        <stop offset="80%" stop-color="#ffd54f" />
                        <stop offset="100%" stop-color="#e6b800" />
                    </radialGradient>
                    <radialGradient id="liq-grad-gold-3" cx="60%" cy="30%" r="50%">
                        <stop offset="0%" stop-color="#e6b800" />
                        <stop offset="50%" stop-color="#b38600" />
                        <stop offset="100%" stop-color="#ffd54f" />
                    </radialGradient>
                    <radialGradient id="liq-grad-gold-4" cx="30%" cy="70%" r="50%">
                        <stop offset="0%" stop-color="#ffd54f" />
                        <stop offset="60%" stop-color="#b38600" />
                        <stop offset="100%" stop-color="#665000" />
                    </radialGradient>
                </defs>
            </svg>
    ...
    const buttons = document.querySelectorAll(".btn:not(.btn-gooey-dynamic), .btn-liquid:not(.btn-gooey-dynamic), .mobile-sticky-item:not(.btn-gooey-dynamic)");
    buttons.forEach(btn => {
        ...
        // Detect gradient IDs depending on classes / hrefs
        let g1 = "liq-grad-1", g2 = "liq-grad-2", g3 = "liq-grad-3", g4 = "liq-grad-4";
        const href = btn.getAttribute("href") || "";
        if (btn.classList.contains("btn-wp") || href.includes("wa.me") || btn.classList.contains("mobile-sticky-item-wp")) {
            g1 = "liq-grad-wa-1";
            g2 = "liq-grad-wa-2";
            g3 = "liq-grad-wa-3";
            g4 = "liq-grad-wa-4";
        } else if (btn.classList.contains("btn-primary") || btn.classList.contains("btn-gold") || btn.classList.contains("btn-liquid")) {
            g1 = "liq-grad-gold-1";
            g2 = "liq-grad-gold-2";
            g3 = "liq-grad-gold-3";
            g4 = "liq-grad-gold-4";
            ...
            g3 = "liq-grad-white-3";
            g4 = "liq-grad-white-4";
        } else if (btn.classList.contains("btn-secondary") || href.includes("tel:") || btn.classList.contains("mobile-sticky-item-call")) {
            g1 = "liq-grad-1";
            g2 = "liq-grad-2";
            g3 = "liq-grad-3";
            g4 = "liq-grad-4";
