document.addEventListener("DOMContentLoaded", () => {
    ...
    /* ==========================================================================
       7. Bento Hero Auto Slider Image Box Controller
       ========================================================================== */
    const bentoHeroSlider = document.getElementById("bentoHeroSlider");
    if (bentoHeroSlider) {
        const slides = bentoHeroSlider.querySelectorAll(".bento-slide");
        const dots = bentoHeroSlider.querySelectorAll(".bento-slider-dot");
        ...
        bentoHeroSlider.addEventListener("mouseenter", () => {
            isHovered = true;
            clearInterval(autoSlideTimer);
            if (progressBar) {
        ...
        bentoHeroSlider.addEventListener("mouseleave", () => {
            isHovered = false;
            resetAutoPlay();
        });
        ...
        bentoHeroSlider.addEventListener("touchstart", (e) => {
            touchStartX = e.changedTouches[0].screenX;
        }, { passive: true });

        bentoHeroSlider.addEventListener("touchend", (e) => {
